...
material, 04_curve_library.py/05_forecast_engine.py get a follow-up change;
...
def run():
    ...
    by_qoy.to_csv(OUT_DIR / "seasonality_quarter_of_year_residuals.csv")
    print(f"\nWrote {OUT_DIR / 'seasonality_quarter_of_year_residuals.csv'}")
