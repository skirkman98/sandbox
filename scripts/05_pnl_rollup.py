...
def main():
    ...
    pnl_consolidated.to_csv(OUT_DIR / "csv" / "pnl_consolidated.csv", index=False)
    ...
    pnl_by_merchant.to_csv(OUT_DIR / "csv" / "pnl_by_merchant.csv", index=False)
    ...
    ltv_cac.to_csv(OUT_DIR / "csv" / "ltv_cac_by_cohort.csv", index=False)
    ...
    by_merchant_ltv.to_csv(OUT_DIR / "csv" / "ltv_cac_by_merchant.csv")
    print("\nLTV/CAC by Merchant:")
